...
'livewire.preview-file','register',
'login','password.request','password.email','password.reset',
'password.store','join','join.update','verification.notice','verification.verify',
'verification.send','password.confirm','logout','dashboard',
'developer-reference','image-upload','admin.2fa','admin.2fa.update','admin.2fa-setup',
'admin.2fa-setup.update','admin.settings.audit-trails.index','admin.settings.roles.index','admin.settings.roles.edit','admin.settings',
'admin.users.index','admin.users.edit','admin.users.show',);
...
'components.tabs.link','errors.400','errors.401','errors.403','errors.404',
