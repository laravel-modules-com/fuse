...
'ide-helper.post_migrate','ide-helper.macroable_traits','laravel-translatable-string-exporter.directories','laravel-translatable-string-exporter.excluded-directories','laravel-translatable-string-exporter.patterns',
...
'laravel-translatable-string-exporter.put-untranslated-strings-at-the-top','livewire.class_namespace','livewire.view_path','livewire.layout','livewire.lazy_placeholder',
...
'livewire.inject_morph_markers','livewire.pagination_theme','modules.namespace','modules.stubs.enabled','modules.stubs.path',
...
'modules.paths.assets','modules.paths.migration','modules.paths.app_folder','modules.paths.generator.channels.path','modules.paths.generator.channels.generate',
'modules.paths.generator.command.path','modules.paths.generator.command.generate','modules.paths.generator.emails.path','modules.paths.generator.emails.generate','modules.paths.generator.event.path',
'modules.paths.generator.event.generate','modules.paths.generator.jobs.path','modules.paths.generator.jobs.generate','modules.paths.generator.listener.path','modules.paths.generator.listener.generate',
...
'modules.paths.generator.route-provider.path','modules.paths.generator.route-provider.generate','modules.paths.generator.repository.path','modules.paths.generator.repository.generate','modules.paths.generator.resource.path',
'modules.paths.generator.resource.generate','modules.paths.generator.rules.path','modules.paths.generator.rules.generate','modules.paths.generator.component-class.path','modules.paths.generator.component-class.generate',
...
'modules.paths.generator.request.generate','modules.paths.generator.config.path','modules.paths.generator.config.generate','modules.paths.generator.migration.path','modules.paths.generator.migration.generate',
'modules.paths.generator.seeder.path','modules.paths.generator.seeder.namespace','modules.paths.generator.seeder.generate','modules.paths.generator.factory.path','modules.paths.generator.factory.namespace',
'modules.paths.generator.factory.generate','modules.paths.generator.lang.path','modules.paths.generator.lang.generate','modules.paths.generator.assets.path','modules.paths.generator.assets.generate',
'modules.paths.generator.views.path','modules.paths.generator.views.generate','modules.paths.generator.component-view.path','modules.paths.generator.component-view.generate','modules.paths.generator.routes.path',
'modules.paths.generator.routes.generate','modules.paths.generator.test-unit.path','modules.paths.generator.test-unit.generate','modules.paths.generator.test-feature.path','modules.paths.generator.test-feature.generate',
...
'modules.activator','modules.cache.enabled','modules.cache.driver','modules.cache.key','modules.cache.lifetime',
'modules-livewire.namespace','modules-livewire.view','permission.models.permission','permission.models.role','permission.table_names.roles',
...
'auth.passwords.users.expire','auth.passwords.users.throttle','auth.password_timeout','mail.default','mail.mailers.smtp.transport',
...
'cache.stores.dynamodb.table','cache.stores.dynamodb.endpoint','cache.stores.octane.driver','cache.prefix','session.driver',
...
'concurrency.default','queue.default','queue.connections.sync.driver','queue.connections.database.driver','queue.connections.database.connection',
...
'cors.allowed_headers','cors.exposed_headers','cors.max_age','cors.supports_credentials','logging.default',
...
'logging.channels.null.driver','logging.channels.null.handler','logging.channels.emergency.path','flare.key','flare.flare_middleware',
...
'livewire.preview-file','ignition.healthCheck','ignition.executeSolution','ignition.updateConfig','register','login',
'password.request','password.email','password.reset','password.store','join',
'join.update','verification.notice','verification.verify','verification.send','password.confirm','logout','dashboard','admin.2fa',
'admin.2fa.update','admin.2fa-setup','admin.2fa-setup.update','admin.settings.audit-trails.index','admin.settings.roles.index',
'admin.settings.roles.edit','admin.settings','admin.users.index','admin.users.edit','admin.users.show',
'admin.blog.index','admin.blog.posts.create','admin.blog.posts.edit','admin.blog.categories.index','admin.blog.authors.index',
'blog.index','blog.posts.index','blog.categories.index','blog.categories.show','blog.authors.index',
'blog.authors.show','blog.rss','blog.archives.index','blog.show',);
        registerArgumentsSet('views', 
'admin::auth.confirm-password','admin::auth.forgot-password','admin::auth.join','admin::auth.login','admin::auth.register',
'admin::auth.reset-password','admin::auth.twofa','admin::auth.twofasetup','admin::auth.verify-email','admin::livewire.admin.dashboard',
'admin::livewire.admin.help-menu','admin::livewire.admin.notifications-menu','audit-trails::livewire.admin.audit-trails','blog::livewire.admin.authors.add','blog::livewire.admin.authors.edit',
'blog::livewire.admin.authors.index','blog::livewire.admin.authors.table-row','blog::livewire.admin.categories.add','blog::livewire.admin.categories.edit','blog::livewire.admin.categories.index',
'blog::livewire.admin.categories.table-row','blog::livewire.admin.posts.add','blog::livewire.admin.posts.edit','blog::livewire.admin.posts.index','blog::livewire.archives',
'blog::livewire.authors','blog::livewire.categories','blog::livewire.index','blog::livewire.post','blog::livewire.postItems',
'blog::livewire.posts','blog::livewire.search','blog::rss','blog::sitemap','components.2col',
'components.a','components.application-logo','components.auth-card','components.button','components.dropdown',
'components.dropdown-link','components.form','components.form.checkbox','components.form.checkbox-row','components.form.ckeditor',
'components.form.date','components.form.daterange','components.form.datetime','components.form.file-upload','components.form.group',
'components.form.input','components.form.radio','components.form.select','components.form.select-option','components.form.select-option-row',
'components.form.select-search','components.form.submit','components.form.textarea','components.form.time','components.form.timeday',
'components.modal','components.nav.droplink','components.nav.group','components.nav.group-item','components.nav.link',
'components.tab','components.tabs.div','components.tabs.header','components.tabs.link','errors.errors',
'errors.flash','errors.messages','errors.status','errors.success','layouts.app',
'layouts.app.navigation','layouts.front','layouts.guest','layouts.plain','roles::livewire.admin.create',
'roles::livewire.admin.edit','roles::livewire.admin.index','settings::livewire.admin.application-settings','settings::livewire.admin.security-settings','settings::livewire.admin.settings',
'users::livewire.admin.activity','users::livewire.admin.edit','users::livewire.admin.edit.admin-settings','users::livewire.admin.edit.change-password','users::livewire.admin.edit.profile',
'users::livewire.admin.edit.roles','users::livewire.admin.edit.two-factor-authentication','users::livewire.admin.index','users::livewire.admin.invite','users::livewire.admin.show',
'users::livewire.admin.user-menu','users::mail.invite','welcome','flash::message','flash::modal',
