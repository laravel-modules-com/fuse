<div>
    <div class="flex justify-between">
        <h1>{{ __('Import {Model }') }}</h1>
        <div class="flex space-x-2">
            <x-a variant="secondary" size="sm" href="{{ route('admin.{module-}.index') }}">{{ __('Back to {Model }') }}</x-a>
        </div>
    </div>
    ...
    <div class="card">
        ...
        @if($step == 1)
            <div class="mb-5">
                ...
                <p class="mb-4">{{ __('Upload a CSV file containing {model} information. The file should have headers in the first row.') }}</p>
        ...
        @if($step == 2)
            <div class="mb-5">
                ...
                <p class="mb-4">{{ __('Map the columns from your CSV file to the required {model} fields.') }}</p>
