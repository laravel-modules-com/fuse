...
<div x-data="{ sidebarOpen: false }">
    <div class="flex min-h-screen">
        ...
        <div id="main" class="w-full bg-gray-100 dark:bg-gray-600">
            ...
            @auth
                <div
                    class="bg-primary dark:bg-gray-700 border-b dark:border-gray-500 flex justify-between px-2 pt-2 pb-1">

                    <div class="flex">
                        <button @click.stop="sidebarOpen = !sidebarOpen" class="md:hidden focus:outline-none pl-1 pr-2">
                            <svg class="w-6 transition ease-in-out duration-150 text-white" fill="none"
