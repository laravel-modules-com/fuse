...
<div>
    ...
    <div class="card">
        ...
        <div class="flex w-full">
            ...
            <div class="w-4/5">
                <x-form.input type="search" name="title" wire:model.blur="title" label="none" placeholder="Search Authors" />
            </div>

            @if (can('add_blog_categories'))
                <div class="md:w-1/5 pl-10">
                    <livewire:blog::admin.authors.add-author/>
                </div>
            @endif
        </div>
        ...
        <div class="overflow-x-scroll">
            ...
            @foreach($this->authors() as $author)
                @include('blog::livewire.admin.authors.table-row', ['author' => $author])
            @endforeach
            </tbody>
            </table>
        </div>
